				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input style="border: 1px solid #e1e1e1; height: 37px; padding: 0 12px;" type="password" name="password" required>
						</div>
						<div class="form-block">
							<label for="phone">Re password*</label>
							<input  style="border: 1px solid #e1e1e1; height: 37px; padding: 0 12px;" type="password" name="re_password" required>
						</div>
						<div class="form-block">
