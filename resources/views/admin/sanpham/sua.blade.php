                ...
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/sanpham/sua/{{$sanpham->id}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea id='demo' class="form-control ckeditor rows="3" required name="mota">{{$sanpham->description}}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Giá sản phẩm</label>
                                <input class="form-control" name="giasanpham" required type="text" value="{{$sanpham->unit_price}}" />
                            </div>
                             <div class="form-group">
                                <label>Giá khuyến mại</label>
                                <input class="form-control" name="giakhuyenmai" required type="text" 
