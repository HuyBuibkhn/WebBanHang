                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/theloaisanpham/sua/{{$loaisanpham->id}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="tenloaisanpham" required value="{{$loaisanpham->name}}" />
                            </div>
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea id='demo' class="form-control ckeditor rows="3" required name="mota">{{$loaisanpham->description}}</textarea>
                            </div>
                            <div class="form-group">
                                <p>
